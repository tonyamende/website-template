import { r as registerInstance, a as readTask, h, F as Fragment, H as Host, g as getElement, c as createEvent } from "./global-7dbfff85.js";
import { B as BaseButton } from "./base-button-BfH8hAk6-90ace3ce.js";
import { c as closestElement, h as hasSlottedElements } from "./shadow-dom-i60z1FJC-4795bd60.js";
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "ad3fe91ce8805dce1d694db9405665d99752646c", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
  get hostElement() {
    return getElement(this);
  }
