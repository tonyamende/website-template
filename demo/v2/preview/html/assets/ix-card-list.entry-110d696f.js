...
import { h as iconMoreMenu, j as iconChevronDown } from "./index-DLTnniMb-a143a692.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "1856a66fb74bada9c6b9c5759aa7c49ae96b6579" }, h(CardListTitle, { key: "057133dcf90e8f06ed452a4f59e925e0f5cefe95", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "fd4634b96598cb038c6a344836a29816f88c6166", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "aef372825c59bfeccc0b8c311a8aa678af506cdd", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "faa99ce7023f23a9215927465b8914305c927590", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
