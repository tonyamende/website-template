...
import { B as BaseButton } from "./base-button-BfH8hAk6-90ace3ce.js";
import { L as LogicalFilterOperator, I as InputState } from "./logical-filter-operator-BH3f5fa3-cf778d91.js";
import { k as iconClear, l as iconSearch } from "./index-DLTnniMb-a143a692.js";
import { m as makeRef } from "./make-ref-bcj7UEIC-1c3883ca.js";
import { a as addDisposableEventListener } from "./disposable-event-listener-CKoABG1h-22559fc4.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "96bb30a0005172a9fdee2eb9a6d5af3d10407706" }, h("form", { key: "cd84cdb5d74d2ff60548ce948639a03943b44da4", ref: (el) => this.formElement = el }, h("div", { key: "612dfd1a4ede3fb598d46748acee0d8efffc2695", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "66fd8cf49866c64b5edf05e1eb508b8f71b9fe79", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: "6e6fbae2c9a462b1a126e73b47571f61607c01e3", class: "token-container" }, h("div", { key: "84ade3aa89605af47dade4d0a05f6b56ca3fba77", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label), h("input", Object.assign({ key: "a6058c78585118ab15dc9a070f8d727e83554cf7", class: {
      "text-input": true,
