import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./global-7dbfff85.js";
import { m as matchBreakpoint } from "./breakpoints-D6vSVaHq-0b67251c.js";
import { D as DateTime, I as Info } from "./datetime-bDicGJUN-62df4ef2.js";
import { O as OnListener } from "./listener-Cu2ljot5-90c42cf7.js";
import { m as makeRef } from "./make-ref-bcj7UEIC-1c3883ca.js";
import { g as iconChevronRightSmall, D as iconChevronLeftSmall, O as iconSingleCheck } from "./index-DLTnniMb-a143a692.js";
...
const DatePicker = class {
  ...
  render() {
    return h(Host, { key: "0a3cba5200b5ade30a51ad27bfa5318fb6e455e9" }, h("ix-date-time-card", { key: "13525eae04d50d4b796c832ad39382af11672d21", corners: this.corners, standaloneAppearance: this.standaloneAppearance }, h("div", { key: "b946cf0018e98db041feac6f1ec157c2663fc7a7", class: "header", slot: "header" }, h("ix-icon-button", { key: "daed6569f3db02faf8be7d6e9ed82a34dd248a6b", onClick: () => this.changeToAdjacentMonth(-1), ghost: true, icon: iconChevronLeftSmall, variant: "primary", class: "arrows" }), h("div", { key: "ad8236ac5c1e6c7bedfb46ddaf4837f4237218db", class: "selector" }, h("ix-button", { key: "18839920362c34d100c33ceefce2a9aa519ccf6a", ghost: true, ref: this.dropdownButtonRef, "data-testid": "year-month-button" }, h("span", { key: "c892549eab5477cbc3e69f4617d970d3fa8afb83", class: "fontSize capitalize" }, this.monthNames[this.selectedMonth], " ", this.selectedYear)), h("ix-dropdown", { key: "06bb800f510cf913c3ec22e65e07160166fad13b", "data-testid": "year-month-dropdown", class: "dropdown", trigger: this.dropdownButtonRef.waitForCurrent(), ignoreRelatedSubmenu: true, placement: "bottom-start" }, h("div", { key: "4fd60bcf90d7c9d95ac0eeab6fffc247eb8521ba", class: "wrapper" }, h("div", { key: "732e7f272ff92c4eb5b09a0b71a6f927f4197421", "data-testid": "year-container", class: "overflow", onScroll: () => this.infiniteScrollYears(), ref: this.yearContainerRef }, this.renderYears()), h("div", { key: "4bea3eb2972474b67d5370dfd69b5337f886e301", class: "overflow", "data-testid": "month-container" }, this.monthNames.map((month, index) => h("div", { key: month, ref: (ref) => {
      ...
      checkPosition: true
    }, name: iconSingleCheck, size: "16" }), h("div", null, h("span", { class: "capitalize monthMargin" }, `${month} ${this.tempYear}`)))))))), h("ix-icon-button", { key: "02c290b0751096b6fb703882384d336b360c8b98", onClick: () => this.changeToAdjacentMonth(1), ghost: true, icon: iconChevronRightSmall, variant: "primary", class: "arrows" })), h("div", { key: "83eb9faf5ec20c84a7cc2b2a1ea07d79db53f414", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "5542418a1a5fe75f595649f10f5fa52d15388b51", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "05848620cfd3dbab1d49e55e15b022da42ccfaa4", class: {
      button: true,
      hidden: !this.range || !this.standaloneAppearance
    } }, h("ix-button", { key: "1fad401a500e195c445cd1742e072819cffe5b2a", onClick: () => this.onDone() }, this.i18nDone))));
  }
  get hostElement() {
...
const LayoutGrid = class {
  ...
  render() {
    return h(Host, { key: "2c999ca61e022612f73a613f08621996bd3195de", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "25863fb87ae527dc17589e205a5058d87c560baa" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "e9f9f3fa4fa9030feb769145ac5e9091de851ed3" }, h("slot", { key: "00380e50b0ef11153c2f8adafe6a8a33cdc0c726" }));
  }
};
Row.style = rowCss;
export {
