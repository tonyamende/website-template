...
import { m as iconCloseSmall } from "./index-DLTnniMb-a143a692.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "7ccc04431b181efbb16c7d5ed14d5eea5f17ca78", class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, h("div", { key: "c2ab9ec7e031ffa63dfebf4cee062b5d7825b974", class: "slot-container" }, h("slot", { key: "c7d520baa440baedef140a7041927074e72c9481" })), !this.disabled && !this.readonly ? h("ix-icon-button", { ghost: true, oval: true, icon: iconCloseSmall, size: "16", tabindex: this.disabled ? -1 : 0, variant: "primary", disabled: this.disabled, onClick: (e) => this.onCloseClick(e) }) : null);
  }
  get hostElement() {
...
const SelectItem = class {
  ...
  render() {
    return h(Host, { key: "9f574f2a536125dc77ea2aab56259e37a8aff7fc" }, h("ix-dropdown-item", { key: "e1dab0e59d5b7cb4aee16a64cc105b6f6c656a3c", class: {
