...
const InputGroup = class {
  ...
  render() {
    return h(Host, { key: "ba35d867fbc675ceacfbf985ae1c4eabce22725c", class: { disabled: this.disabled } }, h("div", { key: "278b075b6160b310ac0c87e70678e57c74a99e1e", class: "group group-start" }, h("slot", { key: "b13a940241dcbbcd65e970bd4741bba538a4fa54", ref: (el) => this.startSlotRef = el, name: "input-start" })), h("slot", { key: "d9d392d7368a36641d4534cef71be623b38e9263" }), h("div", { key: "a248961f31b840d17553aeccb13d1441787828f7", class: "group group-end" }, h("slot", { key: "bdee0a589c4bfd5041508c476163290d47dc320e", ref: (el) => this.endSlotRef = el, name: "input-end" })));
  }
  get hostElement() {
