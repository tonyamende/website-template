...
import { q as iconClose, x as iconShout } from "./index-DLTnniMb-a143a692.js";
...
const MenuAboutNews = class {
  ...
  render() {
    return h(Host, { key: "eea654ba539abc50cfa9d979890c37ab716d400f", class: {
      expanded: this.expanded,
      show: !this.show
    } }, h("div", { key: "f13ec2bc1156c10fd85eadcacc4ef68a4d32a80f", class: "banner-container" }, h("ix-icon", { key: "6542fd37698271d1988a4ae8113cb1fc586c491b", color: "color-inv-contrast-text", name: iconShout, size: "32" }), h("svg", { key: "9e467fb1eb70f5403a886c22eb006fec33d407f9", viewBox: "0 0 48 56", xmlns: "http://www.w3.org/2000/svg" }, h("polygon", { key: "3ba06beff48d62ebd93046de0eafb78fdc069d01", points: "0 0 48 0 48 56 24 48 0 56" }))), h("div", { key: "d3554c46179ca1cb9ea26b85323241043949c3b2", class: "cui-popover-news-header" }, h("ix-typography", { key: "2ad6592139c4a5878622f4001d4a30ce025d745e", format: "label", bold: true }, this.label)), h("ix-icon-button", { key: "20cc0359486787dbd66ccaa6ba72cebd67319ad7", size: "24", icon: iconClose, ghost: true, onClick: () => {
      this.show = false;
      this.closePopover.emit();
    } }), h("div", { key: "37ed3b5c8308e305e051d80b4e0c7f32cc6d3fb2", class: "slot-container" }, h("slot", { key: "04fbd96561b71befc53829b2af6f77591e600cd2" })), this.aboutItemLabel ? h("div", { class: "cui-popover-news-footer" }, h("ix-button", { variant: "primary", onClick: (e) => {
      this.show = false;
      this.showMore.emit(e);
    } }, this.i18nShowMore)) : null, h("div", { key: "5edaac386c73dd3b526aa8007d93e95da1f3362c", id: "arrow" }));
  }
};
