...
import { c as closestIxMenu } from "./context-CKM5pVsv-a58f9e76.js";
...
const MenuCategory = class {
  ...
  render() {
    return h(Host, { key: "3136ce8ed0f0bfdeb30fe7816b3f2426e076b120", class: {
    ...
    } }, h("ix-menu-item", { key: "fa80d8f564e04f0aa0fe91b8731020f02d0500c9", class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onFocus: () => this.onPointerEnter(), isCategory: true }, h("div", { key: "d5ad6e9025e3cf5b1b20c6f92a3f08abef24da16", class: "category" }, h("div", { key: "2e46991622c7b63041d580a3f3fcd5004b50d09b", class: "category-text" }, this.label), h("ix-icon", { key: "b207f24f2c8407621ece0909358ccfcb8e6a7e19", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    } }))), h("div", { key: "1667ae5d3dfe73f69eabb0a6581204afb24b6b97", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    } }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "3eeec32a823b2939c385b047af622d40354d9002", closeBehavior: "both", show: this.showDropdown, onShowChanged: ({ detail: dropdownShown }) => {
    ...
    } }, h("ix-dropdown-item", { key: "89c44571666924180fc6a3e5fe33c47bd077c578", class: "category-dropdown-header" }, h("ix-typography", { key: "230750f5a12ad66c04b757607129d4746ef2913d", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "02f21fd811d9d472162adf93d544a638fa250190" }), h("slot", { key: "e8ade2b1089cbe5b57c823c2e8bf2949ad025dbf" })));
  }
  get hostElement() {
