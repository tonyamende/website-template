...
import { N as iconDocument } from "./index-DLTnniMb-a143a692.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "212e4daec733310184aa933f059ca316f2a0e273", class: {
      disabled: this.disabled,
      "home-tab": this.home,
      "bottom-tab": this.bottom,
      active: this.active,
      "tab-nested": this.isHostedInsideCategory
    } }, extendedAttributes), h("button", { key: "48a07bbbcd0f96f3bcd0d3588914b124042e26b4", class: "tab", tabIndex: this.disabled ? -1 : 0, ref: this.buttonRef }, this.icon && h("ix-icon", { key: "bda340466dabe45e2c350e07ad35ebb4721cc383", class: "tab-icon", name: this.icon }), this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null, h("span", { key: "f96a99a5504474ae3fafab55507fd2138a31148d", class: "tab-text text-default" }, this.label, h("slot", { key: "4792a5228724e4bdb2e7f4eeb13f0dae8d74460a" }))), !this.isCategory && !this.isHostedInsideCategory && !this.menuExpanded && h("ix-tooltip", { key: "047e3c337d81a46e10175000ef9f76c89eba4642", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3 }, this.tooltip));
  }
  get hostElement() {
