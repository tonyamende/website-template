...
import { s as showAppSwitch } from "./index-CxG62M3Y-2f944313.js";
...
import { P as iconNavigationLeft, Q as iconNavigationRight, e as iconApps, R as iconCogwheel, i as iconInfo, S as iconLightDark } from "./index-DLTnniMb-a143a692.js";
...
const Menu = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "f33d825f3a05db6bc2bc3220e6c6145b92def178", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "70e3ee98bcf1004a3483466585287701eccda07e", class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "0bc7a9f77dac1f986fcf4ed9bca92e2ef724e7e0", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "da9ed4391c3848f828654ccdf31baf0549531055", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "affac70b7988e246bcc1ee1f05117a00c7b06b9a", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, ghost: true })), h("div", { key: "fb7e2e7a6dfb6345db462c3505b83931abad1c46", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "0579aefc63155a54eec4676357e9c13d53b532f4", class: "tabs-shadow-container" }, h("div", { key: "f8e8087f402b2e7fae2570c164abf94407d1993b", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "57760012cd3138ed2642e5763e97b0aba1480e43", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "801ebc6ce0a52b7556af7594604d4fff4a141722", class: "menu-avatar" }, h("slot", { key: "f469a4ed48f1d3400b9450eba05cbfeb5ecfa2e8", name: "ix-menu-avatar" })), h("slot", { key: "df73e527ff81ea63c8730354554defd54558776a", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "1693654345856d262bd850d88740aa4a87c43c74", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "01f18b245c60dbe54fc0d594ec504f92e00b7642", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, h("div", { key: "d004cb5daa680766d5f7b126ca772694e88913f9", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "4819e26208049ec8bd02d68c6ceea55c7561b2f8", name: "bottom" })), h("div", { key: "08ef3fcca395182cc9e86b8ebbc23148ac2bf1ea", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme }) : null, this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null), h("div", { key: "58c5b0f708e2a593aa7416a765a446465e37faf7", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "c4ba83dd66595c0fad819a1a490b2e42b0aa38ce", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "7671f01c78c577993b9abc329a560ac4b07b6ae9", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
