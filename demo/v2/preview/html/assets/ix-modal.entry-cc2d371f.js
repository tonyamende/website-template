...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "f2cf319544b05d55221d24f619e50e665ff4d63d", class: {
      visible: this.modalVisible,
      "no-backdrop": this.backdrop === false,
      "align-center": this.centered
    } }, h("div", { key: "6321a973b57268a1d3b3260691a736664ad8cc7f", class: "dialog-backdrop" }, h("dialog", { key: "5e7e0bb5428e3fd1e7103cf3e77edd2df98766f9", "aria-modal": a11yBoolean(true), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      [`modal-size-${this.size}`]: true
    }, onClose: () => this.dismissModal(), onClick: (event) => this.onModalClick(event), onCancel: (e) => {
      e.preventDefault();
      this.dismissModal();
    } }, h("slot", { key: "4a031ffdadca078855b3d8389c8de786844e62b5" }))));
  }
  get hostElement() {
