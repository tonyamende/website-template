...
import { B as iconMinus, C as iconPlus } from "./index-DLTnniMb-a143a692.js";
...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, c as SlotStart, I as InputElement, d as checkAllowedKeys, o as onInputBlur, S as SlotEnd, e as checkInternalValidity } from "./input.util-DORL_qfP-ce3ab8f4.js";
...
const NumberInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "45bdd6fa21f75fbe77883e36cc38eca2499a38ec", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "9ec603198e794931bef7b290aab0757ef3094e0f", id: this.numberInputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "45c11e7d4ddbbac3e7f8b30b62f510cc5d571230", class: {
      "input-wrapper": true,
      "show-stepper-buttons": !!this.showStepperButtons
    } }, h(SlotStart, { key: "a91194c4e07a75a1eca9f051bf1039ab32ce0ac1", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "1e3e5e26501388030dcbbf41748f13d05acbb580", id: this.numberInputId, readonly: this.readonly, disabled: this.disabled, step: this.step, min: this.min, max: this.max, pattern: this.pattern, type: "number", isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(Number(value)), updateFormInternalValue: (value) => this.updateFormInternalValue(Number(value)), onBlur: () => {
      onInputBlur(this, this.inputRef.current);
      this.touched = true;
    } }), h(SlotEnd, { key: "dfad4b24a33dcd57e8585a387160339bc9e6fa6e", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("div", { key: "966a88fdcc7a7d34dbb600905433f0b83541e2a0", class: {
      "number-stepper-container": true,
      "container-hidden": !showStepperButtons
    } }, h("ix-icon-button", { key: "ce34a16a86b4f0db7f4373770e764809def029b1", ghost: true, icon: iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => {
    ...
    } }), h("ix-icon-button", { key: "1f03340752e2a68dfc58530916565db771773ab7", ghost: true, icon: iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => {
      if (!this.inputRef.current) {
        return;
      }
