...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "0662b1d016904af48cd38b4da31b2d672898fb31", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "3ece1d029fc0daa09d834a71fdf1d7ac16122023", ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "489caa92bab68202d6544dc3e5e94ecd618d5f85", class: {
      "with-icon": true
    }, name: this.icon, size: "16" }), h("span", { key: "dd77e86d3f75e0c4d1a7c18847891bfb6c036b5f", class: "slot-container" }, h("slot", { key: "f206fd87c2c6ed8d77f56b473e36f9641aa046a8", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
  get hostElement() {
