...
import { C as iconPlus, k as iconClear, r as iconChevronDownSmall } from "./index-DLTnniMb-a143a692.js";
import { a as a11yBoolean } from "./a11y-Bb7pDeaQ-d6b7242d.js";
import { A as ArrowFocusController } from "./focus-BAKpVknt-628a5ece.js";
...
import "./disposable-event-listener-CKoABG1h-22559fc4.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "fdfc4962114ec9fc4cf0fe61d40787dba81f60a6", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "56517622c68630fd31b5b4e98fc6d7851582fc6e", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "7765a0bf460e16716f50a4f8c7624bcad927667b", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "c2e8b90f7647b38ee8a576dc757084c62fb84179", class: "input-container" }, h("div", { key: "60a9d1b6f7118103c6999bb1f592f3a4ea48c16b", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "eb952ef1b366f58dd6ec38801ef5b3e593199383", class: "trigger" }, h("input", { key: "a41e364dcba508d681a6790381881175716d152d", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    } })))))), h("ix-dropdown", { key: "570a352447ec2b5ad541d9099d015cf0bd106b15", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "0e36c98203e2454bb875800f624c4184e51e6363", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "6188f73b7d46ccba8bc082089c3fa3e97a93fdfc", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "f20e633a7b5b4add9ee28541a987f8a81eb32162", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
