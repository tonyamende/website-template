...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "d8e7be57b4c0185e1188911536cca857a2fcbad6", class: {
      disabled: this.disabled,
      error: !!this.error
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("div", { key: "0ecbe4037919ec19a30af7a9145593cacf80c899", class: "slider" }, h("div", { key: "7d329191a212a1584d50c03228226b4961da69a4", class: "track" }, h("div", { key: "73753249bbb9c1150d74d2e8647f50acf976f70d", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * 100% - 8px)`
    } }), h("div", { key: "9dff9c36ef412b62bea9bb9177652ebd004a8122", class: "ticks" }, this.marker ? this.marker.map((markerValue) => {
    ...
    }) : null)), h("input", Object.assign({ key: "f205b5b801fecde7d0c97f29ec0d664e0ac08a73", id: "slider", type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
      ...
      this.showTooltip = false;
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max }, this.a11yAttributes)), h("ix-tooltip", { key: "7ca900985c873ecded49945c167b57cd06c18290", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), h("div", { key: "86981116ef975e8cb7eed3bcce6fb2039a905dd1", class: "label" }, h("div", { key: "41ee2d7d4589d1bc3d07f27183bb20bb6b427ec0", class: "label-start" }, h("slot", { key: "d62f50d02740fde09ee8831fff7d571fcb79e4a1", name: "label-start" })), h("div", { key: "3ea4c039875cb419e9f9a0458c732f3704dcfe84", class: "label-end" }, h("slot", { key: "f976d54d98f91e2d7820fefa59c8a06d9a700cbb", name: "label-end" }))), this.error ? h("ix-typography", { class: "label-error", textColor: "alarm" }, this.error) : null);
  }
  get hostElement() {
