...
const SplitButton = class {
  ...
  render() {
    ...
    return h(Host, { key: "e0d0edb7066a580eed44a9db08077b4f897d3e98" }, h("div", { key: "d4f51dff8bdfef2e6e61779cd5394becdff6ef62", class: { "btn-group": true, "middle-gap": !this.outline } }, this.label ? h("ix-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) }), this.label) : h("ix-icon-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) })), h("ix-icon-button", Object.assign({ key: "538d5b20c17dd9f2fdb08190923d33f0b988f0b6" }, buttonAttributes, { ref: (r) => this.triggerElement = r, class: "anchor", icon: (_a = this.splitIcon) !== null && _a !== void 0 ? _a : iconContextMenu }))), h("ix-dropdown", { key: "16cb268e7a1f5a164892c61081a443a68a1351db", ref: (r) => this.dropdownElement = r, closeBehavior: this.closeBehavior }, h("slot", { key: "6ceb1837a636cb12b4721f55bfb1914099a38c18" })));
  }
  get hostElement() {
