...
import { g as iconChevronRightSmall, D as iconChevronLeftSmall } from "./index-DLTnniMb-a143a692.js";
...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "697240aa0a6cea43ec97640085ec2cf541a78d48", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "5643cc69b8b251357c555dc0e63179d7771c8d9a", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "f3764262304d84c583c5639e2bb0e0a5b4ff9207" })), h("div", { key: "1ab87c4153dc574f1dc1090a6c06e4c78c57ed3c", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "bd8619bc438827e9f0b2589ae9b211f5ebee5be1" }, this.showArrowPrevious && h("div", { key: "b6f01b886a187b3c24c0ad085dcc0e3351e0d230", class: "arrow", onClick: () => this.move(this.scrollAmount, true) }, h("ix-icon", { key: "c63fe3247042b0caee48bc8b3edee715835dcee7", name: iconChevronLeftSmall })), h("div", { key: "baf421e42a1f06336e927beaa88ee743072270b7", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "3fe86f3d355af51c43031d92a23dae80a32f28a7", class: "items-content" }, h("slot", { key: "555a70f38df04ee9b539990f0580ff66e147b42d" }))), this.showArrowNext && h("div", { key: "09b57787a1d09aec19993530c22ee1f92cc164c2", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true) }, h("ix-icon", { key: "69e17007eb7f7f2ede082ff2573fa746b8f67ffe", name: iconChevronRightSmall })));
  }
  get hostElement() {
