...
import { m as mapValidationResult, T as TextareaElement, o as onInputBlur } from "./input.util-DORL_qfP-ce3ab8f4.js";
...
const Textarea = class {
  ...
  render() {
    return h(Host, { key: "55cd5e6371c8b3b532fbb40b87a47cd202ad9f6a", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "8201f2979c0c5b5008f977ef33d3af9cdaec5a9e", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.textAreaRef }, !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "9876618d55b0dc6fa02bb42af76be48d2d6f7740", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (this.value || "").length, "/", this.maxLength), h("div", { key: "20d08ea483592314320e7f68f44f4e948d5015b8", class: "input-wrapper" }, h(TextareaElement, { key: "0f95d77dbd295857c39c5aea97440b0b3dbc0aeb", minLength: this.minLength, maxLength: this.maxLength, textareaCols: this.textareaCols, textareaRows: this.textareaRows, textareaHeight: this.textareaHeight, textareaWidth: this.textareaWidth, resizeBehavior: this.resizeBehavior, readonly: this.readonly, disabled: this.disabled, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, textAreaRef: this.textAreaRef, valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
