...
import { I as iconClock } from "./index-DLTnniMb-a143a692.js";
import { D as DateTime } from "./datetime-bDicGJUN-62df4ef2.js";
import { d as dropdownController } from "./dropdown-controller-D3K9vmFp-56197464.js";
import { a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, c as SlotStart } from "./input.util-DORL_qfP-ce3ab8f4.js";
import { c as createClassMutationObserver, H as HookValidationLifecycle } from "./validation-CS0nhfz1-5108567d.js";
...
const TimeInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "abe977cb8fc1a42c0df2118b37889f9678ebdf5b", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "302a0ba9eb5e20a46c12ec621daca553515bab65", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "f6b54e2644b9934a17b54a60a55ed25c9a85b79f", "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    } }, h("ix-time-picker", { key: "c7beea8a47c8a2d7c524d5eb40c46b25a961f939", ref: this.timePickerRef, format: this.format, time: (_a = this.time) !== null && _a !== void 0 ? _a : "", hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, standaloneAppearance: false, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
