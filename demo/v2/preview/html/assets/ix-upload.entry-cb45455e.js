...
import { U as UploadFileState } from "./upload-file-state-BGzrnl_l-efe6c7ce.js";
import { c as iconSuccess, b as iconError } from "./index-DLTnniMb-a143a692.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "29ff8dafbed7944021260f84e1c5f8ee96efe723" }, a11y, { "aria-disabled": disabled }), h("div", { key: "2730737ebda0402b27253f48d6d79b21b351cfd7", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "f0059a89387c7d457060aefdcf697895803647f8" }, h("input", { key: "e7de98f28c8c038a998ed8e16fc105adc273392e", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "1a9dfd68eb1181b7da90fa229a53385531a5d7e5", "aria-disabled": disabled, outline: true, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
